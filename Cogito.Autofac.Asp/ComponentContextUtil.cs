...
namespace Cogito.Autofac.Asp
{
    ...
    /// <summary>
    /// Provides methods to resolve objects within Classic ASP requests.
    /// </summary>
    public static class ComponentContextUtil
    {
        ...
        /// <returns></returns>
        static object  ResolveWithProxyFunc(IComponentContextProxy proxy, Func<IComponentContextProxy, object> resolve)
        {
            if (proxy == null)
        ...
        /// <param name="resolve"></param>
        /// <returns></returns>
        static object  ResolveFunc(Func<IComponentContextProxy, object> resolve)
        {
            var proxy = GetProxy();
            if (proxy == null)
        ...
        /// <param name="resolve"></param>
        /// <returns></returns>
        static object ResolveApplicationFunc(Func<IComponentContextProxy, object> resolve)
        {
        ...
        /// </summary>
        /// <returns></returns>
        static IComponentContextProxy GetApplicationProxy()
        {
        ...
        /// </summary>
        /// <returns></returns>
        static IComponentContextProxy GetProxy()
        {
            var request = (IRequest)System.EnterpriseServices.ContextUtil.GetNamedProperty("Request");
            if (request == null)
                throw new InvalidOperationException("Unable to locate request context.");
